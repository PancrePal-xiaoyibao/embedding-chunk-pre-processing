...
try:
    # 新的src目录结构导入
    from src.core.document_structure_analyzer import DocumentStructureAnalyzer, SectionType
    from src.core.preprocess_enhanced import EnhancedDocumentPreprocessor
except ImportError:
    # 向后兼容的导入
    try:
