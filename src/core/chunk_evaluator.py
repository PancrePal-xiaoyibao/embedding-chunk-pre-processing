...
class ChunkEvaluator:
    ...
    def __init__(self, target_chunk_size: int = 1000, chunk_boundary_marker: str = "[CHUNK_BOUNDARY]"):
        """
        初始化评估器
        
        Args:
            target_chunk_size: 目标分块大小（字符数）
...
def main():
    ...
    try:
        result = evaluator.evaluate_file(test_file)
        evaluator.print_evaluation_report(result, test_file)
